...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update Your Booking Details') ; ?> <?php //echo CHtml::encode($model) ?></legend>
    <?php echo $this->renderPartial('_form',array('model' => $model,'radioshowname' => $radioshowname,'timebelttitle' => $timebelttitle,)); ?>
</fieldset>